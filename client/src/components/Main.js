  ...
  return (
    <>
      <div className="header">
        <div className="header_title">KYM</div>
        <div className="menu_wraper">
          <div className="menu selected" index={0} onClick={() => setCurrentPage(0)}>
            Contact & Introduce
          </div>
          <div className="menu" index={1} onClick={() => setCurrentPage(1)}>
            Work Experience
          </div>
          <div className="menu" index={3} onClick={() => setCurrentPage(3)}>
            Tech Skills
          </div>
          <div className="menu" index={4} onClick={() => setCurrentPage(4)}>
            License and Certificate & Education
          </div>
        </div>
      </div>
      <ReactPageScroller pageOnChange={handlePageChange} customPageNumber={current_page}>
          ...
          <div className="container">
              ...
              <div className="contact">
                ...
                <div className="content">
                  ...
                  <p>
                    ...
                    <b>
                      <a href="https://github.com/hjk70288">https://github.com/hjk70288</a>
                    </b>
                  </p>
                </div>
              </div>
            ...
            <Fade right duration={1300}>
              ...
              <div className="introduce">
                <div className="content">
                  올해 2월부터 현재까지 (주)세븐미어캣에서 웹 서비스를 기획/개발/배포/운영하고 있습니다.
                  <br />
        ...
        <div className="full_page">
          <div className="container">
            ...
            <Fade right duration={1500}>
              ...
              <img className="to_top" src={top_button_icon} alt="" onClick={() => setCurrentPage(0)} />
            </Fade>
          </div>
        </div>
      </ReactPageScroller>
